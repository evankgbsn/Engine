...
GraphicsPipeline::GraphicsPipeline(const Window& w) :
	...
	layout(new PipelineLayout(Renderer::GetVulkanPhysicalDevice()))
{
	vertShader = new Shader(std::string("../Engine/Engine/Renderer/Pipeline/Shaders/TriangleVert.spv"), Renderer::GetVulkanPhysicalDevice());
	fragShader = new Shader(std::string("../Engine/Engine/Renderer/Pipeline/Shaders/TriangleFrag.spv"), Renderer::GetVulkanPhysicalDevice());
